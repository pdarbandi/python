...
print(key_list_items("people", people=['pete', 'mike', 'jan', 'tom'], things=['book', 'tv']))


print(key_list_items("ages", things=['book', 'tv', 'shoes'], people=['pete', 'mike', 'jan', 'tom'], ages=[20, 30, 40]))
